...
import {ZunamiPoolControllerBaseUpgradeable} from "./ZunamiPoolControllerBaseUpgredable.sol";

contract ZunamiPoolCompoundControllerUpgradeable is ZunamiPoolControllerBaseUpgradeable, ERC20PermitUpgradeable {
    ...
    function initialize(
        ...
        __ZunamiPoolControllerBase_init(pool_);
        __ERC20_init(name_, symbol_);

        feeDistributor = msg.sender;

        managementFeePercent = 150; // 15%
        emit ManagementFeePercentSet(0, managementFeePercent);
    }
